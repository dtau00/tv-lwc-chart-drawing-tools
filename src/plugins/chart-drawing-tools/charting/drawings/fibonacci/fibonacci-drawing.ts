...
import { BoxSide, getBoxHoverTarget, getCursorForBoxSide, updateBoxPosition } from '../../../common/points';
...
export class FibonacciDrawing extends ChartDrawingBase{
	...
	private _updatePosition(startPoint: Point, endPoint: Point, side: BoxSide): void {
		...
		[dp1, dp2] = updateBoxPosition(startPoint, endPoint, this.drawingPoints[0], this.drawingPoints[1], side, this._chart, this._series, false)
