...
export class ToolLineHorizontal extends Tool {
    ...
    getNewDrawingObject(chart: IChartApi, series: ISeriesApi<SeriesType>, symbolName: string): LineHorizontalDrawing {
        return new LineHorizontalDrawing(chart, series, symbolName);
    }
